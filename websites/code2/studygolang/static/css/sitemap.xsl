	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="intro">
					<p>
						This is a XML Sitemap which is supposed to be processed by search engines like <a href="http://www.google.com">Google</a>, <a href="http://www.baidu.com">Baidu</a>, <a href="http://search.msn.com">MSN Search</a> and <a href="http://www.yahoo.com">YAHOO</a>.<br />
