...
func RegisterRoutes(g *echo.Group) {
	...
	new(AuthController).RegisterRoute(g)
	new(UserProfileController).RegisterRoute(g)
	new(UserContentController).RegisterRoute(g)
	...
	new(AnnouncementController).RegisterRoute(g)
	new(VersionController).RegisterRoute(g)
}
